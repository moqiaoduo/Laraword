...
<head>
    ...
    <title>{{ config('app.name', 'Laraword') }}</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    @foreach(\App\Content::where('type','page')->get() as $val)
                        <li class="nav-item"><a class="nav-link" href="{{getCustomRoute(getCustomUri(json_decode(getSetting('routeTable'),true),'page'),$val)}}">{{$val['title']}}</a></li>
                    @endforeach
                </ul>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @guest
                        ...
                        @if(getSetting('allow_register'))<li><a class="nav-link" href="{{ route('register') }}">{{ __('Register') }}</a></li>@endif
                    @else
